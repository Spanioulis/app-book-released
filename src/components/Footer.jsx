...
const Footer = () => {
   return (
      <footer className="footer footer-center p-10 text-base-content dark:text-gray-400 rounded">
         ...
         <div>
            ...
            >
               <a
                  ...
                  className="flex flex-col link link-hover my-auto"
               >
                  <svg
                     ...
                     height="24"
                     viewBox="0 0 24 24"
                     className="fill-main dark:fill-tahiti hover:fill-dark dark:hover:fill-gray-400"
                  >
         ...
         <div>
            <p>Copyright © 2022 - All right reserved by Spanioulis</p>
         </div>
      </footer>
   );
};
