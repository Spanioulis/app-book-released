...
const HeroUpload = () => {
   return (
      <div className="hero min-h-96 pt-16 pb-8  text-metal dark:text-gray-300">
         <div className="hero-content text-center">
            <div className="max-w-md">
               <h1 className="max-w-xl mb-4 text-xl font-extrabold tracking-tight leading-none md:text-4xl xl:text-5xl text-metal dark:text-gray-300">
